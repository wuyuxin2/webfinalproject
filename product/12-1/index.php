...
<body>
	...
	<div class="secondbar-firstpage">首页</div> 
	<div class="secondbar-product">产品</div>
	<div class="secondbar-mall">商城</div>
	<div class="secondbar-stores">体验店</div>
	<div class="secondbar-service">服务</div>
